#!/usr/bin/env python
"""Run step 2, no noise, no knit simulation and save results."""
...
print("Running step 2, no noise, no knit...")
np.random.seed(12)
...
print(f"\nData saved to data/ferm_num_step2_epsilon08_no_noise_no_knit.txt")
print(f"Data saved to data/bs_error_step2_epsilon08_no_noise_no_knit.txt")
