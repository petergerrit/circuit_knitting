#!/usr/bin/env python3
"""
Run 10 separate runs of first Trotter step with epsilon=0.4 and 16384 shots.
...
if __name__ == "__main__":
    ...
    combined_output = {
        "experiment": "step1_knitted_eps0p4",
        "epsilon": epsilon,
        "num_shots": num_shots,
        "num_runs": num_runs,
        "trotter_step": 1,
    ...
    # Save to JSON file
    output_filename = os.path.join(results_dir, "step1_knitted_eps0p4.json")
