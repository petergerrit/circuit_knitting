#!/usr/bin/env python3
"""
Run 10 separate runs of second Trotter step with epsilon=0.6 and 16384 shots.
...
if __name__ == "__main__":
    ...
    combined_output = {
        "experiment": "step2_knitted_eps0p6",
        "epsilon": epsilon,
        "num_shots": num_shots,
        "num_runs": num_runs,
        "trotter_step": 2,
    ...
    # Save to JSON file
    output_filename = os.path.join(results_dir, "step2_knitted_eps0p6.json")
