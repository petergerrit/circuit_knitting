#!/usr/bin/env python3
"""
Test for first Trotter step (step 1) fermion number measurement and bootstrap error.

This test creates a circuit with Trotter step 1 preparation,
...
def test_first_trotter_step_fermion_number():
    """Create step 1 circuit, measure fermion number, and compute bootstrap error."""
    circuit.measure_all()
...
def test_first_trotter_step_fermion_number_knitted():
    """Run the step 1 circuit through circuit knitter, measure fermion number, and compute bootstrap error."""
...
if __name__ == "__main__":
    fermion_num, error = test_first_trotter_step_fermion_number()
    print(f"\nFirst Trotter step fermion number: {fermion_num:.4f} +/- {error:.4f}")
    
    knitted_fn, knitted_err = test_first_trotter_step_fermion_number_knitted()
