#!/usr/bin/env python3
"""
Plot fermion number convergence as a function of shots for step 2 knitted results.

Loads results from step2_knitted_all_shots.json and plots fermion number
with bootstrap error bars vs. number of shots.
Also adds fermion number with bootstrap error band from step2_summary_seed42.json.
"""
...
results_dir = "results"
input_file = os.path.join(results_dir, "step2_knitted_all_shots.json")
...
plt.title('Step 2 Fermion Number Convergence (Noiseless)', fontsize=28)
