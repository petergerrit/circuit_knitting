...
if __name__ == "__main__":
    ...
    fermion_num, error, summary_file, shots_file = save_step2_fermion_number()
    # print(f"\nSecond Trotter step fermion number: {fermion_num:.4f} +/- {error:.4f}")
    
    # print("\nRunning knitted second Trotter step fermion number analysis...")
    knitted_fn, knitted_err, k_summary_file, k_shots_file = save_step2_fermion_number_knitted()
