#!/usr/bin/env python3
"""
Run 10 separate runs of Trotter step 0 (initial state) with epsilon=0.8 and 16384 shots.
...
# Create step 0 circuit (initial state only, no Trotter evolution)
...
if __name__ == "__main__":
    ...
    combined_output = {
        "experiment": "step0_knitted_eps0p8",
        "epsilon": epsilon,
        "num_shots": num_shots,
        "num_runs": num_runs,
        "trotter_step": 0,
    ...
    # Save to JSON file
    output_filename = os.path.join(results_dir, "step0_knitted_eps0p8.json")
