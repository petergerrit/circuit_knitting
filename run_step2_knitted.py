#!/usr/bin/env python
"""Run step 2, no noise, knitted simulation and save results."""

import numpy as np
from circuit_utils.params import trot_step_2, mid
...
print("Running step 2, no noise, knitted...")
np.random.seed(13)
...
print(f"\nData saved to data/ferm_num_step2_epsilon08_no_noise_knitted.txt")
print(f"Data saved to data/bs_error_step2_epsilon08_no_noise_knitted.txt")
